...
- Player challenges can select the virtual `IdleRPG` opponent as one additional opponent choice. Set `enableBotOpponent` to `false` to restrict battles to active player characters.
