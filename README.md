...
- When an inactive character is automatically reactivated, the channel receives the original-style “is now online” announcement with the character's Discord mention and time to the next level. Returning during the offline grace period does not announce a login because the character never became inactive.
